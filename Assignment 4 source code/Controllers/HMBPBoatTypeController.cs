...
{
    public class HMBPBoatTypeController : Controller
    {
        private readonly SailContext _context;

        public HMBPBoatTypeController(SailContext context)
        {
            _context = context;
        }
        ...
        // GET: HMBPBoatType/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: HMBPBoatType/Create
