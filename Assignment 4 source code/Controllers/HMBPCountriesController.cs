...
{
    public class HMBPCountriesController : Controller
    {
        ...
        // GET: HMBPCountries/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: HMBPCountries/Create
