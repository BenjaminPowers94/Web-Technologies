...
{
    public class HMAnnualFeeStructureController : Controller
    {
        private readonly SailContext _context;

        public HMAnnualFeeStructureController(SailContext context)
        {
            _context = context;
        }

        // GET: HMAnnualFeeStructure
        public async Task<IActionResult> Index()
        {
            return View(await _context.AnnualFeeStructure.OrderByDescending(m => m.Year).ToListAsync()); // Oder by year
        }

        // GET: HMAnnualFeeStructure/Details/5
        ...
        // GET: HMAnnualFeeStructure/Create
        ...
        // POST: HMAnnualFeeStructure/Create
        ...
        // GET: HMAnnualFeeStructure/Edit/5
        ...
        // POST: HMAnnualFeeStructure/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: HMAnnualFeeStructure/Delete/5
        ...
        // POST: HMAnnualFeeStructure/Delete/5
