...
{
    public class HMTasksController : Controller
    {
        private readonly SailContext _context;

        public HMTasksController(SailContext context)
        {
            _context = context;
        }
