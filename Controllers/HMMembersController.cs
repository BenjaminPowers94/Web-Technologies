...
{
    public class HMMembersController : Controller
    {
        private readonly SailContext _context;

        public HMMembersController(SailContext context)
        {
            _context = context;
        }
